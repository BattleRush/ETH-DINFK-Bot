...
namespace ETHBot.DataLayer.Migrations
{
    ...
    [Migration("20240204004041_MakeDiscordFileFullPathUnique2")]
    partial class MakeDiscordFileFullPathUnique2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.DiscordAttachment", b =>
                {
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.DiscordFile", b =>
                {
                    b.Property<int>("DiscordFileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UrlWithoutParams")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.DiscordFileEmbeds", b =>
                {
                    b.Property<int>("DiscordFileEmbedId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte[]>("Embed")
                        .HasColumnType("longblob");

                    b.Property<int>("PytorchModelId")
                        .HasColumnType("int");

                    b.HasKey("DiscordFileEmbedId");

                    b.HasIndex("DiscordFileId");

                    b.HasIndex("PytorchModelId");

                    b.ToTable("DiscordFileEmbeds");
                });
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.OcrBox", b =>
                {
                    b.Property<int>("OcrBoxId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TopRightX")
                        .HasColumnType("int");

                    b.Property<int>("TopRightY")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.PytorchModel", b =>
                {
                    b.Property<int>("PytorchModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ForAudio")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("ForImage")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("ForVideo")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.HasKey("PytorchModelId");

                    b.ToTable("PytorchModels");
                });
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.SavedQuery", b =>
                {
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.SavedQueryParameter", b =>
                {
                    b.Property<int>("SavedQueryParameterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("SavedQueryParameterId");

                    b.HasIndex("SavedQueryId");

                    b.ToTable("SavedQueryParameters");
                });
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.ETH.Food.DiscordUserFavouriteRestaurant", b =>
                {
                    ...
                    b.ToTable("DiscordUserFavouriteRestaurants");
                });

            modelBuilder.Entity("ETHBot.DataLayer.Data.ETH.Food.Food2050CO2Entry", b =>
                {
                    b.Property<int>("Food2050CO2EntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<double>("CO2Delta")
                        .HasColumnType("double");
                    ...
                    b.Property<double>("TemperatureChangeDelta")
                        .HasColumnType("double");

                    b.HasKey("Food2050CO2EntryId");

                    b.HasIndex("RestaurantId");

                    b.ToTable("Food2050CO2Entries");
                });
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.ETH.Food.Menu", b =>
                {
                    ...
                    b.Property<string>("DirectMenuImageUrl")
                        .HasColumnType("longtext");

                    b.Property<string>("FallbackMenuImageUrl")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.ETH.Food.Restaurant", b =>
                {
                    ...
                    b.Property<bool>("IsFood2050Supported")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.DiscordFileEmbeds", b =>
                {
                    b.HasOne("ETHBot.DataLayer.Data.Discord.DiscordFile", "DiscordFile")
                        .WithMany()
                        .HasForeignKey("DiscordFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ETHBot.DataLayer.Data.Discord.PytorchModel", "PytorchModel")
                        .WithMany()
                        .HasForeignKey("PytorchModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DiscordFile");

                    b.Navigation("PytorchModel");
                });
            ...
            modelBuilder.Entity("ETHBot.DataLayer.Data.Discord.SavedQueryParameter", b =>
                {
                    b.HasOne("ETHBot.DataLayer.Data.Discord.SavedQuery", "SavedQuery")
                        .WithMany()
